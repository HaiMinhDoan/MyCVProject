...
<html lang="en">
        ...
        <div class="container">
            ...
            <div class="form-container" style="padding: 20px">
                <div class="form-left" style="width: 100%">
                    <form action="UpdateSubject" method="POST" id="formSubmit">
                        <div class="form-row">
                            <div class="form-group ">
                                <label for="subject-name">Subject Name</label>
                                <input type="hidden" value="${s.subjectId}" id="subject-name" name="sid">
                                <input type="text" value="${s.subjectName}" id="subject-name" name="subject-name">
                            </div>
                            <div class="form-group ">
                                <label for="subject-code">Subject code</label>
                                <input type="text" value="${s.subjectCode}" id="subject-code" name="subject-code">
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <select name="course">
                                <c:forEach var="c" items="${cl}">
                                    <option ${s.courseId == c.courseId? "selected":""} value="${c.courseId}">${c.courseName}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input value="${s.subjectPrice}" type="number" id="price" name="price">
                            </div>
                            <div class="form-group">
                                <label for="price">Sale Price</label>
                                <input value="${s.salePrice}" type="number" id="salePrice" name="salePrice">
                            </div>

                        </div>
                        <div class="form-group">
                            <label for="img">Create Date </label>
                            <input type="date" id="date" name="date" value="${s.createdDate}" disabled="">
                        </div>
                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea  id="description" name="description" rows="4">${s.subjectDescription}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="status">Status</label>
                            <select id="status" name="status">
                                <option value="1" ${s.isActive()?"selected":""}>Active</option>
                                <option value="0" ${!s.isActive()?"selected":""}>Inactive</option>
                            </select>
                        </div>
                        <div>Image:</div>
                        ...
                        <div class="">
                            ...
                            <input type="radio" name="imgBy" id="byBase64" value="byBase64" onchange="disableField('img', 'link', 'srcRoot')">
                            <input type="file" id="img" name="img"  accept="image/*" disabled onchange="convertToBase64()"><br><br>

                            <label for="byLink">Import Link</label>
                            <input type="radio" name="imgBy" id="byLink" value="byLink" onchange="disableField('link', 'img', 'srcRoot')">
                            <input type="text" name="link" value="" id="link" disabled="" onkeyup="disableField('link', 'img', 'srcRoot')" ><br><br>

                            <label for="noChange">No Change</label>
                            <input type="radio" name="imgBy" id="noChange" value="noChange" onchange="disableField('srcRoot', 'link', 'img')">
                            <input type="text" hidden id="srcRoot" value="${s.subjectImage}" name="srcRoot">


                            <input type="text" hidden="" id="imgText" name="imgText">
                            <div hidden="" id="temp64"></div>
                        </div>
                        <div class="form-actions">
                            <a  href="SubjectList" class="btn" type="button">Back</a>
                            <button type="button" onclick="changeImgText()"   value="save" >Submit</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function disableField(focusField, disableField1, disableField2) {
            ...
            if (focusField === "img") {
                ...
                srcString = document.getElementById("srcRoot").value;
                document.getElementById("imgContent").src = srcString;
            }
