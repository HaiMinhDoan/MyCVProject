            ...
            <div class="container-fluid">
                ...
                <div class="search navbar-collapse" id="navbarSupportedContent" style="display: flex;">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked"onchange="switchTheme()">
                        <label class="form-check-label" for="flexSwitchCheckChecked"><i class="bi bi-brightness-high"></i></label>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="row full-height justify-content-center">
                    <div class="col-12 text-center align-self-center py-5">
                        <div class="section pb-5 pt-5 pt-sm-2 text-center">
                            ...
                            <input class="checkbox" type="checkbox" id="reg-log" name="reg-log" ${isLogin?"":"checked"}/>
                                                ...
                                                <form action="Account" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="email" name="logemail" class="form-style"
                                                               placeholder="Your Email" id="logemail" autocomplete="off" value="${logemail}">
                                                        <i class="input-icon uil uil-at"></i>
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <input type="password" name="logpass" class="form-style"
                                                               placeholder="Your Password" id="logpass" autocomplete="off" value="${logpass}">
                                                        <i class="input-icon uil uil-lock-alt"></i>
                                                    </div>
                                                    <button type="submit" name="actionCheck" class="btn mt-4" value="login">submit</button>
                                                    <p class="mb-0 mt-4 text-center"><a href="ForgetPass" class="link">Forgot your
                                                            password?</a></p>
                                                ...
                                                <form action="Account" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="logname" class="form-style"
                                                               placeholder="Your Full Name" id="logname" autocomplete="off" value="${logname}">
                                                    ...
                                                    <button type="submit" name="actionCheck" class="btn mt-4" value="register">submit</button>
                                                    <div style="color: red" ${errorMess!=null?"hiden":""}>${errorMess}</div>
                                                </form>
                                            </div>
                                        </div>
