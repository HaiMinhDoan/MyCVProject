...
<html lang="en" data-bs-theme="light">
    ...
    <body>
        ...
        <br><br><br><br><br>
        <h2 class="mx-auto center-text">Add  POST</h2>
        ...
        <div class="container ">
            <div class=" d-flex"  style="width: 100%; ">
                <form action="BlogAdd" method="post" style="width: 100%; ">
                    ...
                    <div class="">
                        ...
                        <input type="radio" name="postImage" id="byBase64" value="byBase64" onchange="disableField('img', 'link')">
                        <input type="file" id="img" name="img"  accept="image/*" disabled onchange="convertToBase64()"><br><br>

                        <label for="byLink">Import Link</label>
                        <input type="radio" name="postImage" id="byLink" value="byLink" onchange="disableField('link', 'img')">
