...
<html lang="en">
    ...
    <body>
        <div class="container mt-5">
            <h2 class="mb-4">List customers</h2>
            ...
            <form method="post" action="../sale/account" style="background-color: #ddd; padding: 10px; margin-bottom: 10px">
                ...
                <tbody>
                    <c:forEach var="user" items="${userList}">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="../sale/account?action=view&userId=${user.userId}">Detail</a>
                            </td>
                        </tr>
                    </c:forEach>
