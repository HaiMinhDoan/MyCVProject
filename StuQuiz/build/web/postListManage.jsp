...
<html lang="en" data-bs-theme="light">
    ...
    <body>
        ...
        <br><br><br><br><br>
        <h2 class="mx-auto center-text">Manage POST</h2>
        <div class="container " style="position: sticky; top:0px; z-index: 9999;">
            <td> <a href="./BlogAdd" class="btn btn-info" style="width: 100px" target="_blank">Add</a></td>
        </div>
        <br><br><br>
        <div class="container text-center">
            <div class=" d-flex"  style="width: 100%; ">
                <form class="d-flex container" role="search" style="align-items: center;" action="BlogManage" method="get">
                ...
                <tbody>
                    <c:forEach items="${posts}" var="p">
                        <tr>
                            <td>${p.postId}</td>
                            <td>${p.hashTag}</td>
                            <td><img src="${p.postImage}" width="150px"  alt="..."></td>
                            <td>${p.createdDate}</td>
                            <!--<td>${p.getSummary50()}</td>-->
                            <td> <a href="./BlogUpdate?bid=${p.postId}" class="btn btn-warning">Update</a></td>
                            <td> <a href="./BlogDelete?bid=${p.postId}" class="btn btn-danger">Delete</a></td>
        ...
        <nav style="margin-left: 44%" aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item"><a class="page-link" href="./BlogManage?index=1&content=${param.content}&fromDate=${param.fromDate}&toDate=${param.toDate}">First</a></li>
                    <c:forEach var="i" begin="1" end="${totalPages}" step="1">
                    <li class="page-item"><a class="page-link" href="./BlogManage?index=${i}&content=${param.content}&fromDate=${param.fromDate}&toDate=${param.toDate}">${i}</a></li>
                    </c:forEach>
                <li class="page-item"><a class="page-link" href="./BlogManage?index=${totalPages}&content=${param.content}&fromDate=${param.fromDate}&toDate=${param.toDate}">Last</a></li>
            </ul>
        </nav>
