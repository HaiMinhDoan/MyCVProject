...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <div class="searchbar">
                <form method="get" action="DashBoard" id="searchBox">
                    ...
                    <div class="nav-upper-options">
                        ...
                        <div class="option2 nav-option">
                            <img src=
                                 ...
                                 class="nav-img" 
                                 alt="articles">
                            <h3> <a href="BlogManage" target="_blank">Posts</a></h3>
                        </div>
                        ...
                        <div class="nav-option option3">
                           ...
                           <h3 class="r-subject"><a href="SubjectList" target="_blank">Subjects</a></h3>
                        </div>
                        ...
                        <div class="nav-option option4">
                            <img src=
                                 ...
                                 class="nav-img" 
                                 alt="institution">
                            <h3> <a href="admin/account" target="_blank">Users</a></h3>
                        </div>
                        ...
                        <div class="nav-option option6">
                            <img src=
                                 ...
                                 class="nav-img" 
                                 alt="settings">
                            <h3> <a href="request-teacher" target="_blank">Teacher Request</a></h3>
                        </div>
            ...
            <div class="main">
                ...
                <div class="report-container">
                    <div class="report-header">
                        ...
                        <div class="view">
                            <form method="get" action="DashBoard" id="sortForm">
