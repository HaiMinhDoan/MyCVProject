...
<html lang="en" data-bs-theme="light">
    ...
    <body>
        ...
        <div class="container">
                    ...
                    <c:forEach items="${listLesson}" var="listlesson">
                        <ul>
                            <li>
                                ...
                                <div class="btn-group" role="group">
                                    <a href="AddQuiz?lessonId=${listlesson.lessonId}" class="btn btn-primary">
                                        <i class="bi bi-plus"></i> Add Quiz
                                    </a>
                                    <a href="Lessons?actionCheck=viewLesson&lessonId=${listlesson.lessonId}" class="btn btn-primary">
                                        <i class="bi bi-eye"></i> View
                                    </a>
                                    <button type="button" class="btn btn-primary" onclick="openEditModal('${listlesson.lessonId}', '${listlesson.lessonName}', '${listlesson.videoLink}', '${listlesson.lessonDescription}')">
                                        <i class="bi bi-pencil"></i> Edit
                                    </button>
                                    <c:if test="${listlesson.isActive() == true}">
                                        <form action="./EditLesson" method="get" onsubmit="return confirmDeletion()">
                                            <input type="text" name="lessonId" value="${listlesson.lessonId}" hidden="">
                                            <input type="text" name="actionCheck" value="setInactive" hidden="">
                                            <button type="submit" class="btn btn-danger">Inactive</button>
                                        </form>
                                    </c:if>

                                    <c:if test="${listlesson.isActive() == false}">
                                        <form action="./EditLesson" method="get">
                                            <input type="text" name="lessonId" value="${listlesson.lessonId}" hidden="">
                                            <input type="text" name="actionCheck" value="setActive" hidden="">
            ...
            <div class="sidebar">
                <div class="card">
                    <img style="max-height: 200px; max-width: 300px" src="java-maven.png" alt="Java Maven">
                    <a href="#" class="enroll-button">ENROLL COURSE</a>
                ...
                <div class="related-courses card">
                    ...
                    <c:forEach items="${relatedSubject}" var="relatedSubject">
                        <ul>
                            <li>
                                <img style="max-width: 100px; max-height: 100px; min-height: 100px; min-width: 100px;" src="${relatedSubject.subjectImage}" alt="Course 1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="EditLesson" method="get">
                            ...
                            <input type="hidden" name="actionCheck" value="updateLesson">
        ...
        <script>
                                            function openEditModal(lessonId, lessonName, videoLink, description) {
                                            ...
                                            function confirmDeletion() {
                                                return confirm("Are you sure you want to set this lesson to Inactive?");
                                            }
        </script>
    </body>
</html>
