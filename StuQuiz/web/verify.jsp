    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-tertiary container">
            <div class="container-fluid">
                <a class="navbar-brand" href="http://127.0.0.1:5500/Front_End/homepage.html">StuQuiz</a>
                                        ...
                                        <div class="center-wrap">
                                            <div class="section text-center">
                                                <form action="Verify" method="post">
                                                    <h4 class="mb-4 pb-3">Verify</h4>
                                                    <div class="form-group mt-2">
                                                        <input type="email" name="logemail" class="form-style"
                                                               placeholder="Your Email" id="logemail" autocomplete="off" readonly value="${email}" hidden>
                                                        <i class="input-icon uil uil-at"></i>
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <input type="password" name="logcode" class="form-style"
                                                               placeholder="Your Verify Code" id="logcode" autocomplete="off">
