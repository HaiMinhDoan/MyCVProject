                                                ...
                                                <form action="ConfirmChangePass" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="email" name="email" class="form-style"
                                                               placeholder="Your Email" id="email" readonly="" value="${param.email}">
                                                        <i class="input-icon uil uil-at"></i>
                                                        <input type="text" name="key" class="form-style"   placeholder="Your Key" id="key" >
                                                        <input type="password" name="pass" class="form-style" placeholder="Your New Password" id="pass" >
                                                    </div>
                                                    <button type="submit"  class="btn mt-4" >submit</button>
                                                    <p class="mb-0 mt-4 text-center"><a href="Account" class="link">Login</a></p>
