...
<html lang="en" data-bs-theme="light">
    ...
    <body>
        ...
        <br><br>
        <h2 class="mx-auto center-text">${b.hashTag}</h2>
        ...
        <div style="display: flex; justify-content: center; flex-direction: column; align-items: center;" class="container">
            <img src="${b.postImage}" style="width: 70%" alt="...">
            <p class="list-group-item">Create date: ${b.createdDate} </p>    
            <p class="list-group-item">Author: ${b.author.userName} </p>
